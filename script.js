...
const adicionarTarefa = () => {
    ...
    if (input === "" || input ===  " " || input === null) {
        ...
        const renderizarLista = (existeTarefaConcluida) => {
            if (!existeTarefaConcluida) {      
                console.log("Não existem tarefas finalizadas");
                ...
                console.log("Existem tarefas finalizadas");
        ...
        renderizarLista(existeTarefaConcluida);
